...
<body class="bg-gray-100">
    {{-- este sera nuestro template header, para colocar el apartado que comparten todas las paginas --}}
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="flex gap-2 items-center">
                    ...
                    {{-- formulario para cierre de sesion y tener segurida con directivas --}}
